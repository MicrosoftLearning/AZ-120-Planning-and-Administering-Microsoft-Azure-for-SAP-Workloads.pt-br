...
1. Na guia **Básico** da página **Criar Instância Virtual para soluções SAP**, especifique as seguintes configurações e selecione **Avançar: Máquinas virtuais**
    ...
    >**Observação**: selecione **Red Hat Enterprise Linux 8.4 para aplicativos SAP — x64 Gen2 mais recente**.
...
1. No prompt, insira: `more /etc/fstab` e encontre uma saída parecida com a seguinte, que corresponde ao mapeamento do compartilhamento SAP Media (`sapmedia`):
